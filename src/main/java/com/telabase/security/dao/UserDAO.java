...
public class UserDAO {
	...
	public List<User> findUserByAppRole(String role){
		return ObjectifyService.ofy()
        .load()
        .type(User.class)
        .filter("appRole", role)
	...
	public User findUserByReferenceObjectId(long id){
		return ObjectifyService.ofy()
        .load()
        .type(User.class)
        .filter("appReferObjectId", id)
        .first().now();
	}
	...
	public List<User> findUserByReferObjectIdAndAppRole(String objid, String appRole){
		return ObjectifyService.ofy()
        .load()
        .type(User.class)
        .filter("appReferObjectId", Long.parseLong(objid))
